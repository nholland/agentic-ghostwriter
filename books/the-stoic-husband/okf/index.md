...
title: The Stoic Husband — Knowledge Bundle
description: >
  Open Knowledge Format bundle for The Stoic Husband. A portable, atomized,
  cross-linked version of the book's evidence layer — every framework, story,
  and citation from sources/evidence-library.md migrated to typed concepts.
  sources/evidence-library.md has been retired (see its tombstone) in favor of
  this bundle, per the OKF v0.1 spec at .claude/OKF.md.
okf_version: "0.1"
tags: [stoic-husband, evidence]
timestamp: 2026-07-11T00:00:00Z
---

# The Stoic Husband — Knowledge Bundle

This bundle is the book's knowledge layer: one markdown file per knowledge
unit, each with typed frontmatter and cross-links, per the
[Open Knowledge Format](https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md)
spec adapted at `.claude/OKF.md`.

It supersedes `sources/evidence-library.md`, which has been replaced with a
tombstone pointing here. `sources/` remains raw intake only
(`author-notes.md`, `audience-signals.md`, `interviews/`, `articles/`); this
bundle is the curated, atomized result.

See [README.md](/README.md) for the original pilot assessment and integration
notes.

## Frameworks

Author-developed models and lenses. Author IP — never cited as external
research unless explicitly noted under `# Citations`.

- [The Virtue Question (The Inward Turn)](/frameworks/the-virtue-question.md) — the book's daily operating tool; the practical version of Arête
- [Attachment vs. Devotion](/frameworks/attachment-vs-devotion.md) — the Stoic line on love without neediness
- [The Dichotomy of Control in Marriage](/frameworks/dichotomy-of-control-in-marriage.md) — what a husband does and doesn't control in conflict
- [The Four-Question Epictetan Marriage Rule](/frameworks/four-question-epictetan-marriage-rule.md) — the real-time sequence before reacting
- [Prohairesis — The Faculty of Moral Choice](/frameworks/prohairesis-faculty-of-moral-choice.md) — the faculty marriage either strengthens or enslaves
- [The Role Frame (Ego vs. Role)](/frameworks/the-role-frame-ego-vs-role.md) — ego asks "am I winning?"; role asks "what does love require?"
- [The Five Hidden Judgments](/frameworks/the-five-hidden-judgments.md) — the second-order conflicts beneath most marital fights
- [Romance as Disciplined Attention](/frameworks/romance-as-disciplined-attention.md) — romance as noticing, not grand gestures
- [Virtuous vs. Performative Romance](/frameworks/virtuous-vs-performative-romance.md) — same behavior, different inner source: anxiety vs. character
- [Pursue Fully. Release the Outcome.](/frameworks/pursue-fully-release-the-outcome.md) — brave love without neediness
- [The Five Qualities of Stoic Love](/frameworks/the-five-qualities-of-stoic-love.md) — Chosen, Expressive, Free, Virtuous, Mortal
- [The Deferral Ratchet — Three Good Reasons and the Door That Closes](/frameworks/the-deferral-ratchet.md) — how a man reaches years of silence without ever deciding to; the third deferral manufactures a fourth that isn't a choice
- [Seagull and Torpedo](/frameworks/seagull-and-torpedo.md) — the two failed speaking styles; silence isn't the opposite of the seagull, it's the fuse on the torpedo
- [Say It, Don't Require a Response](/frameworks/say-it-dont-require-a-response.md) — the resolution: courage to say it kindly, no obligation to extract agreement; what makes early-and-often affordable
- [Double Standards — Which Ones Are Real](/frameworks/double-standards-real-and-false.md) — three cases: the same problem in two shapes, a real difference never said out loud, and a standard with nothing underneath
- [Endurance Is Not the Highest Virtue](/frameworks/endurance-is-not-the-highest-virtue.md) — sometimes endurance is love, sometimes it's fear
- [The Stoic Divorce Test (12 Questions)](/frameworks/the-stoic-divorce-test-12-questions.md) — twelve questions for evaluating whether to stay or leave
- [Three-Question Decision Frame](/frameworks/three-question-decision-frame.md) — hardship vs. betrayal, mutual effort, what staying makes of you
- [Marriage Cannot Survive Unilateralism](/frameworks/marriage-cannot-survive-unilateralism.md) — survives deprivation, not unilateral decisions
- [Marriage as a Mirror of the Soul](/frameworks/marriage-as-mirror-of-the-soul.md) — conflict as material for self-knowledge
- [Marriage as the Death of the Imagined Self](/frameworks/marriage-as-the-death-of-the-imagined-self.md) — marriage says "prove it" to the self you imagine you are
- [Marriage as a Discipline of Perception](/frameworks/marriage-as-a-discipline-of-perception.md) — marriages collapse from accumulated interpretations, not events
- [Marriage as Contest Against Contempt](/frameworks/marriage-as-contest-against-contempt.md) — the great enemy of marriage is contempt, not conflict
- [Marriage as Gratitude Under Impermanence](/frameworks/marriage-as-gratitude-under-impermanence.md) — memento mori applied to an ordinary Tuesday
- [The Village Problem](/frameworks/the-village-problem.md) — why a cold marriage becomes catastrophic when one person is the whole village
- [Love vs. Desire (Perel)](/frameworks/love-vs-desire-perel.md) — love wants familiarity, desire needs mystery
- [Marriage as Community of Life (Musonius Rufus)](/frameworks/marriage-as-community-of-life.md) — perfect companionship, mutual love, shared everything
- [Bring Steadiness, Not Superiority](/frameworks/bring-steadiness-not-superiority.md) — the governing principle for a Stoic in a mixed marriage
- [Virtue and Happiness Are Not Enemies](/frameworks/virtue-and-happiness-are-not-enemies.md) — moral acts build the conditions for durable happiness
- [Daily Stoic Marriage Practices](/frameworks/daily-stoic-marriage-practices.md) — five-practice daily framework drawing on Marcus, Epictetus, Musonius, Seneca
- [Arête as Secular Load-Bearer](/frameworks/arete-as-secular-load-bearer.md) — identity architecture for non-religious men
- [The Operating System: Trigger, Meaning, Autopilot](/frameworks/the-operating-system-trigger-meaning-autopilot.md) — a marriage runs on trigger → loaded meaning → automatic response; the Ch1 gap sits before the response fires
- [Metacognition and the Internal Dialogue](/frameworks/metacognition-and-the-internal-dialogue.md) — the "three-second gap" named as the deeper mechanism: metacognition
- [Compassion vs. Empathy (The Stoic Distinction)](/frameworks/compassion-vs-empathy.md) — see and respond (compassion) vs. absorb and mirror (empathy)
- [Emotional Contagion (The Human Mirror)](/frameworks/emotional-contagion-the-human-mirror.md) — mood mirroring is a feature of being human, not a marital pathology
- [The Descent to Beast (Stoic Impulse Governance)](/frameworks/the-descent-to-beast.md) — ungoverned impulse drags a man below his rational self
- [Humor and Lightness as Stoic Practice](/frameworks/humor-and-lightness-as-stoic-practice.md) — eudaimonia is flourishing, not grimness; lightness is Stoic
- [Preferred Externals (Terminology Handling)](/frameworks/preferred-externals-terminology.md) — prefer "preferred external" over "preferred indifferent" in prose
- [The Intertwined Life (Author Personal Frame)](/frameworks/the-intertwined-life.md) — the author's 23-year intertwined marriage as a personal frame
- [Biological Mate-Seeking → Marriage Complacency](/frameworks/biological-mate-seeking-vs-marriage-complacency.md) — energy invested in courtship decays into complacency
- [The 4Ds (Defensive Response Taxonomy)](/frameworks/the-four-ds-defensive-response-taxonomy.md) — Defense, Deny, Downplay, Deflect — ego-protecting responses to criticism
- [The Courage to Correct Without Needing to Win](/frameworks/the-courage-to-correct-without-needing-to-win.md) — state the true thing once, calmly, and release the outcome
- [Respect as a Resource](/frameworks/respect-as-a-resource.md) — respect is a finite boundary; anger at its breach is evolutionarily coherent
- [The Behavioral Loop (Anger Persists Because It Works)](/frameworks/the-behavioral-loop-anger-persists-because-it-works.md) — anger continues because it gets results
- [The Anger Spectrum](/frameworks/the-anger-spectrum.md) — anger ranges from hot/verbal to cold/withdrawing; the cold man may not see himself in "rage"
- [Disdain as Anger's Endpoint](/frameworks/disdain-as-angers-endpoint.md) — unrepaired anger solidifies into disdain, contempt's precursor
- [The Nail Parable](/frameworks/the-nail-parable.md) — each anger drives a nail; calming pulls it out but the hole stays
- [The New Partner Is Not Better (The River Comparison)](/frameworks/the-new-partner-is-not-better-river-comparison.md) — the new partner isn't better, the circumstances are different
- [The Cigarette Close](/frameworks/the-cigarette-close.md) — you don't know which cigarette gave you the diagnosis; small acts accumulate
- [The Arena (Virtue Requires Testing)](/frameworks/the-arena-virtue-requires-testing.md) — virtue exists only when tested; an easy marriage proves nothing
- [The Evening Review (Stoic Night Practice)](/frameworks/the-evening-review-stoic-night-practice.md) — three nightly questions that reprogram the autopilot
...
Real audience signals and author anecdotes, used as composite scenarios.

- [Sexless and Roommates](/stories/sexless-and-roommates.md) — slow-disconnection opener for Ch 16/17
- [I Haven't Felt Desired in Years](/stories/i-havent-felt-desired-in-years.md) — the "Paul at the end of a long road" portrait
- [Take Sex Off the Table](/stories/take-sex-off-the-table.md) — a grassroots Stoic-aligned approach to a dead bedroom
- [Screaming from the Rooftops](/stories/screaming-from-the-rooftops.md) — communication without being heard, 25 years in
- ["Touched-Out" and the Dead Bedroom](/stories/touched-out-and-the-dead-bedroom.md) — how parental exhaustion converts into marital distance
- [Any Issues Before Kids Will Be Magnified](/stories/any-issues-before-kids-will-be-magnified.md) — the "Eric alert" before children arrive
- [Marriage at Year 27, Clashing in the Kitchen](/stories/marriage-at-year-27-clashing-in-the-kitchen.md) — the compound interest of decades of conflict-resolution practice
- [Things We Tolerate](/stories/things-we-tolerate.md) — the author's own list of friction he's made peace with; Ch11's relieving beat
- [The One-Time Loan](/stories/the-one-time-loan.md) — Ch10, a real, already-resolved family-of-origin money-boundary example
...
External sources backing factual claims. Each carries a verification
...
- [Seneca — "We May Weep, But We Must Not Wail"](/citations/seneca-weep-but-not-wail.md) — status: verifiable
...
- [Marcus Aurelius — "If It's Endurable, Then Endure It" (Meditations 10.3)](/citations/marcus-aurelius-meditations-10-3-endurable-or-not.md) — status: verifiable — Ch11's primary anchor; Marcus sorts first and instructs by branch, which is the chapter's own method
- [Marcus Aurelius — "It Is in Our Power to Have No Opinion" (Meditations 6.52)](/citations/marcus-aurelius-meditations-4-3-no-opinion.md) — status: verifiable — Ch11's tolerating row; Long VI.52, transcribed from Gutenberg (the 4.3 locator was wrong; slug kept for links)
- [Treynor, Gonzalez & Nolen-Hoeksema (2003) — Brooding vs. Reflective Pondering](/citations/treynor-2003-brooding-vs-reflection.md) — status: verifiable — the line between interiority that is the work and interiority that is the poison; load-bearing for Ch11
...
- [Seneca — De Beneficiis: Against Keeping Accounts of Benefits Given](/citations/seneca-de-beneficiis-against-keeping-accounts.md) — status: verifiable — classical anchor for non-transactional giving
- [Marcus Aurelius — Meditations Book 7: Against Seeking Credit or Repayment for Good Deeds](/citations/marcus-aurelius-meditations-book7-no-repayment.md) — status: verifiable — single-line Stoic anchor for releasing the ledger
- [Sex as Recurring Ritual of Choosing Each Other (Not Just Desire)](/citations/sex-as-ritual-choosing-each-other.md) — status: superseded — resolved into Bounded Generosity, Not Obligation and its six citations below
- [Basson (2000) — Responsive vs. Spontaneous Sexual Desire](/citations/basson-2000-responsive-vs-spontaneous-desire.md) — status: verifiable — initiation/closeness can precede desire rather than requiring it first
- [Muise, Schimmack & Impett (2016) — Sexual Frequency and Well-Being](/citations/muise-2016-sexual-frequency-well-being.md) — status: verifiable — N=30,645; well-being plateaus around once-weekly frequency
- [Impett & Peplau (2005) — Approach vs. Avoidance Sexual Motives](/citations/impett-peplau-2005-approach-avoidance-sexual-motives.md) — status: verifiable — avoidance-motivated compliance predicts the lowest relationship satisfaction of any group studied
- [Muise, Impett, Kogan & Desmarais (2013) — Sexual Communal Strength](/citations/muise-2013-sexual-communal-strength.md) — status: verifiable — care-motivated (not avoidance-motivated) engagement sustains desire; "unmitigated communion" caveat included
- [Vowels & Mark (2020) — Strategies for Mitigating Sexual Desire Discrepancy](/citations/vowels-mark-2020-mitigating-desire-discrepancy.md) — status: verifiable — open communication about mismatch predicts better outcomes than forcing or avoiding
...
- [Rokach, Sha'ked & Ben-Artzi (2022) — LIRS: Detachment, Hurt, Guilt](/citations/rokach-et-al-2022-lirs-detachment-hurt-guilt.md) — status: verifiable — validated scale for loneliness inside a relationship; guilt factor names the shame of feeling lonely despite having a partner
- [Sprecher (2001) — Equity and Social Exchange in Dating Couples](/citations/sprecher-2001-equity-and-social-exchange.md) — status: verifiable — underbenefiting inequity predicts lower satisfaction/commitment; overbenefiting doesn't carry the same cost
- [DeMaris (2010) — 20-Year Trajectory of Marital Quality](/citations/demaris-2010-20-year-trajectory-marital-quality.md) — status: verifiable — equity's link to marital quality doesn't fade with marriage duration
...
- [Kahneman & Deaton (2010) vs. Killingsworth (2021) vs. Killingsworth, Kahneman & Mellers (2023) — Income and Happiness](/citations/kahneman-killingsworth-income-and-happiness.md) — status: verifiable — supersedes the outdated "modest income plateau" claim
- [Seligman, Steen, Park & Peterson (2005) — Gratitude Visit vs. Three Good Things](/citations/seligman-2005-gratitude-visit-vs-three-good-things.md) — status: verifiable — corrects a source's inverted "most lasting" claim
- [Santos (2018) — "Psychology and the Good Life" (Yale PSYC 157)](/citations/santos-2018-psychology-and-the-good-life.md) — status: verifiable
- [Hanson — "Taking In the Good" / HEAL Method (Hardwiring Happiness)](/citations/hanson-taking-in-the-good.md) — status: unverified — mechanism confirmed, specific "12-second" duration is not
- [McDermott, Fowler & Christakis (2013) — Divorce Clustering Through Social Networks](/citations/christakis-fowler-divorce-clustering.md) — status: unverified — **unassigned**; dropped from Ch10 in the 2026-08-17 rebuild (friends demoted to a pressure, not a domain); real peer-reviewed source, but the underlying statistical method has been publicly challenged
...
- [Epictetus — Discourses II.18: Put the Impression to the Test](/citations/epictetus-discourses-2-18-test-the-impression.md) — status: verifiable / paraphrase — Ch1's impression-and-assent anchor; modern rendering, no canonical translator
