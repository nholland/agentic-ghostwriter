...
Any man can stand upright when the water's flat. Maybe you've called that steadiness: being okay when conditions cooperate, level when the house is quiet. But flat water doesn't test anything. Some men have peaceful houses and call it character. It might just be timing.

The Stoic question is different: do you have your sea legs? Can you stay governed when the externals stop cooperating? When she comes in carrying something heavy. When the day left a mark on you. When the house is loud and everyone needs something at once. That's when the *hegemonikon* either holds or it doesn't.
...
## Editor's Notes (/book-chapter-refine session — 2026-06-24)

### Why this pass ran
The author asked to re-refine this already-refined chapter specifically to see
how the newly hardened counted voice rules (Cat G–J in `01-voice.md` and
`book-chapter-refine.md`) play out against existing prose, and to compare the
delta. This chapter's own Draft Notes had also flagged an unresolved
structural issue from the original refine pass: the opening still led with
the wife-comes-home scene rather than the philosophical anchor, repeating
Chapter 1's opening type in direct violation of `04-archetype.md`'s rule
against consecutive identical opening types.

### What Changed
- **Opening reorder (structural):** Moved the Epictetus *Enchiridion* quote
  and "Study that list..." analysis ahead of the "Your wife comes home..."
  scene. Chapter now opens philosophical-anchor-first; Chapter 1 opens
  scene-first. Resolves the archetype-variety violation noted in this
  chapter's own draft notes but never previously fixed.
- **Cat H — Metaphor saturation (counted, verified by recount).** Initial
  count: the weather/temperature family appeared 6 times against 1,401 body
  words — a cap of roughly 4 at 3/1,000 words. Cut two non-anchor instances:
  "The temperature in the house when you walk through the door" (line 50)
  rephrased to "What she's carrying when you walk through the door," and "It
  moved the way weather moves" (cascade section) rephrased to "It moved on
  its own, the way these things do." Final verified count: 4 — at the cap,
  with the establishing instance (line 14), the first "temperature" mention
  (line 10), and the title-anchoring closing line ("a man with his own
  weather, who knows how to come home") preserved.
- **Cat J — Rhetorical device repetition.** Verified count of the negated-
  comparison/reframe shape ("X isn't/wasn't that. It's/That's Y."): 2
  instances ("That's not this," in the corrective section; "That's not
  loving her. That's adding to her weight," in the closing). At the cap, no
  fix needed.
- **Cat G, I:** checked, no violations. All four bolded lines are structural
  beat labels, consistent with the Ch1 precedent. The closing sentence has
  nothing following it.

### For the Author's Review
- The "mirroring"/contagion vocabulary (mirror, mirrors, mirroring) runs
  alongside the weather metaphor as a second recurring image. I judged this
  as a named psychological concept the chapter introduces and tracks (parallel
  to how Ch1 names "operating system" as its umbrella mechanism), not a
  competing physical metaphor stacked on top of weather — so I left it as is.
  Flagging in case you read it differently.

### Length Check
1,401 words vs. outline target 1,200–1,500 — within range.
