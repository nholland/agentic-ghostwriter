...
applied_by: grep -q 'grilling' /home/user/agentic-ghostwriter/runs/ch12/refined.md
---

# The platinum paragraph needs one concrete instance: care in your language vs. care in hers.

You ruled platinum over golden, and the brief calls this the chapter's most useful single paragraph. But the brief supplies only the abstraction - 'her currency, not yours' - and no example of what effort in your language actually looks like versus what registers as care for her. 01-voice.md is explicit that this fails: 'Use specific, named detail. Not she was upset. What she said, what he did.' One pair of examples fixes it: a thing you have done that felt like real effort to you and did not land, and a thing that does land for her that costs you less than you would expect.

**Recommendation:** One pair from your own marriage. This is the paragraph most likely to be the chapter's pull-quote, and it is the one a reader tests against his own life immediately.

**Checked:**

```
gw-ghostwriter plan-only gate, 2026-09-15: 'It supplies the abstraction (her currency, not yours) and the receiving-side half, but no example of what care in his language versus hers actually looks like. 01-voice.md makes a purely abstract version a voice failure.'
```

**What unblocks this:** Whether the platinum paragraph is written concrete or abstract - and an abstract one is a voice failure by the spec's own words.
