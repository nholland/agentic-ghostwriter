...
This was a refine, not a rescue. The draft arrived with every HARD check passing.
Every change below is line-level except the two flagged at the bottom.

### What changed and why

**Pass 0 — approachability.**
- `atrophies` now carries an inline plain-English gloss ("which means it wastes
  away"). It is the one word in the chapter a 12-year-old would need a
  dictionary for, and `01-voice.md`'s Red Flag on elevated vocabulary names
  exactly this case. The gloss adds no family word and reaches for none of the
  banned cousins.
- Three sentences over 20 words were split where the split cost nothing:
  "So it goes first, quietly, every time. You never catch it happening..."
  and "Those are two different lists. The second one is worse to write..."
  and "Then resentment. It's the ordinary word... Long enough that she stops
  expecting better."
- "the thing in your kitchen" is now "the kitchen faucet," and "the thing she's
  been dreading at work" is now "the meeting at work she's been dreading." Both
  were the indirect-gesture failure `01-voice.md` names by name (*can the clause
  be replaced with the plain noun? Then replace it*), and the spec's
  "specific, named detail" rule wants the object named. Flagged below.
- "Here was an old man ranking them out loud to a groom" is now "...out loud to
  me." Same fact, no distancing.

**Pass 1 — voice.**
- **One windup cut:** "The reverse is the part nobody warns you about." It
  announced the next sentence and added nothing. Nine words recovered.
- "top priority" (three times, mild management register) is now "put her first,"
  which is the grandfather's own words being unpacked rather than a paraphrase
  of them. Shorter and plainer.
- "Discipline is the word you'd use for that, and you'd use it accurately" is now
  "You'd call that discipline, and you'd be right."
- "None of it works as a transaction" is now "It doesn't work as a trade."
  *Transaction* is not on the banned list literally, but it is the accounting
  register the brief rules out, and Ch7 owns it.
- "A communication researcher named Milton Bennett named the problem" lost its
  double *named*: "A communication researcher, Milton Bennett, named the
  problem with that back in 1979." Attribution unchanged, one clause, still not
  a house coinage.
- Four sentences turned active: "Your wife reads that corner...", "She reads
  love in you asking...", "People sometimes call his version...", "She'll see a
  man performing romance at her..."

**Pass 2 — clarity.**
- "The kids grow and go. That's the job." read ambiguously: *the job* could
  attach to putting her first. Now "The kids grow and go. They're supposed to."
- "Only one of you can see why it didn't land" made the reader work out which
  one. Now "She's the only one who can see why it didn't land."
- "effort comes out of a supply that runs down" is now "you only have so much
  effort in a day." Same mechanism, plainer, and in second person.
- "keep finding the same shape" is now "the same pattern." "That's what the
  research carries" is now "All the research says is that these things travel
  together," which stops at the same place D-3 stopped it and reads as English.
- "They have dates attached" is now "They have a day attached." The chapter uses
  *date* in its romantic sense twice within sixty words of that line.
- "You can't win favor with a person you quit learning" is now "...someone you
  stopped learning about."

**Pass 3 — flow.** One close, one sentence, nothing after it. See the flag below.

**Pass 4 — anti-slop, counted.** Script output verbatim, below. The regex found
one reframe against a cap of 2. Reading for the shapes it cannot count turned up
a real one it missed: the **pseudo-cleft** ("What X is Y") ran five times.
*What I think he was saying is...*, *What she reads is...*, *What he proposed
instead...*, *What she'll see is...*, *What lands is...*. Four were rewritten;
the fifth, "What lands is the detail you kept and the question you came back
to," is the chapter's best sentence and keeps the shape once.

Counted by hand, the constructions the regex does not model:
- reframe / negation pair: **2** ("It isn't about you, it's about her";
  "That's not her being petty. That's what anyone does"). At cap.
- colon-then-label: **2** (Democritus, the muscle line). The colon introducing
  the grandfather's quotation is a quote marker, not the device.
- "It's [noun]" as a labelling sentence: **2**.
- pseudo-cleft: **1**, down from 5.
- Two further antithetical pairs ("You're supposed to say your family is
  everything. You're not supposed to rank the people inside it." and "He got
  plenty wrong. He got this right.") are a concession and an expectation-setter
  rather than the reframe device. **Judgement call:** a stricter reader could
  count all four as one family and call it over cap. Both are in beat 1, both
  are load-bearing, and I left them.

### The three CAND lines, read

1. **Single ending, clear.** Rewritten. See the flag below.
2. **Rhetorical-device repetition, clear.** Not a pass. See the hand counts above;
   the script missed a shape that was genuinely over cap.
3. **Stoic term gloss, clear.** Accepted. Marcus is grounded in plain words
   ("a Roman emperor and a Stoic," *Meditations* as "the private notebook he
   kept for himself"). **Standing note, not acted on:** the bare word *Stoicism*
   in "If you've read any Stoicism at all" carries no gloss. Glossing the book's
   own subject in chapter 12 would cost words the budget doesn't have and would
   read as condescension. Raising it so the omission is on the record.
...
### The three 25+ word sentences

All three are artifacts of the script joining prose across a bolded beat label
(the flagged strings visibly run into `**The second piece...`, `**The first
thing cut.**`, `**What it costs.**`). No real sentence in the chapter runs 25
words. The longest real one is the close, at 22.

### Flagged, not decided — the author may reverse either

**1. The close was rewritten.** This is the one change that touches argument
rather than sentence mechanics, and it was the specific judgement the dispatch
asked me to make.

- Draft: *"She was never waiting on the feeling: she's been waiting to be the
  necessary thing, and that's a muscle you can start using tonight."*
- Refined: *"She's been waiting to be one of the necessary things, and putting
  her there is a muscle you can start using tonight."*

Four reasons, in order of weight. **(a)** "She was never waiting on the feeling"
answers an objection the chapter never raises. Feeling appears nowhere in the
prose before that clause, because the energy-allocation mechanism superseded the
feeling framing. `01-voice.md` bans planting a doubt in order to defeat it, and
the clause was defeating the *outline's* superseded premise in front of a reader
who never held it. **(b)** Tense clash: *was never waiting* against *she's been
waiting*, with *waiting* twice. **(c)** "that's a muscle" had no clean referent:
being the necessary thing is not a muscle. "Putting her there" is the thing the
reader does, and it is what the image describes. **(d)** It was a third instance
of the negation-pair device, which sits at cap.

What survives intact: the Marcus callback (now matching his plural *necessary
things* and the "two different lists" line exactly), the protected closing use of
the image, one sentence, nothing after it, and the action landing on *tonight*.
What is lost: the explicit disposal of the feeling-follows-practice framing. If
the author wants that disposal printed, the draft line restores it at a cost of
2 words and the four problems above.

**2. The kitchen object is now named.** "The thing in your kitchen" became "the
kitchen faucet," and the knuckles and the trip for the part now have something to
attach to. This sits inside the invented second-person composite that Draft Notes
identify as the reader's, never the author's, so naming the object invents nothing
about his life. But it is a detail that did not exist before, in a passage already
pending the author's word (inbox #009). If he supplies a real instance of his own,
the whole passage lifts out as Draft Notes describe and this detail goes with it.

**3. Minor, for the record.** "Romance ebbs and flows" is kept verbatim as the
author's own wording, though it is a water figure in a chapter whose declared
image is the muscle and in a Part whose preamble owns the elemental imagery. It
is a dead idiom, undeveloped, one clause. Not changed.

### Untouched, by ruling

The grandfather's quoted line, the date admission with no recovery clause after
it, the bare-minimum line, the absence of any Marcus quotation or placeholder
standing in for one, the absence of the five love languages and of any named
attribution for the responsiveness idea, and the absence of a courtship beat
(inbox #011). No citation was marked verified. No placeholder was resolved,
...
### Carried forward from Draft Notes

`metaphor_family: muscl,atroph`. The draft's supersession block (six stale
`03-outline.md` rows, the composite-passage swap instructions, and the rulings
