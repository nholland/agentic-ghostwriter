...
The practices from each chapter, in one place, in the order they appear in the
book. Each one is tagged **Proactive** (a standing habit or a scheduled check,
run on a rhythm whether or not anything has gone wrong yet) or **Reactive**
(something you do once a specific moment has already started). The tags are
there so you can see the balance at a glance. Neither kind outranks the other.
